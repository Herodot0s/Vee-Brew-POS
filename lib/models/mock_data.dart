...
const List<Category> mockCategories = [
  ...
  Category(
    id: 'frappe_non_coffee',
    name: 'Frappe (No-Coffee)',
...
const List<Product> mockProducts = [
  ...
  Product(
    id: 'cc_wintermelon',
    name: 'Wintermelon Cheesecake',
    basePrice: 43.0,
    categoryId: 'cheesecake',
  ),
  Product(
    id: 'cc_okinawa',
    name: 'Okinawa Cheesecake',
    basePrice: 43.0,
    categoryId: 'cheesecake',
  ),
  Product(
  ...
  Product(
    id: 'ftw_melon',
    name: 'Melon Fruit Tea',
    basePrice: 35.0,
    categoryId: 'fruit_tea_water',
  ),
  Product(
    id: 'ftw_four_season',
    name: 'Four Season Fruit Tea',
    basePrice: 35.0,
    categoryId: 'fruit_tea_water',
  ),
  ...
  Product(
    id: 'pf_mango_graham',
    name: 'Mango Graham Premium',
    basePrice: 55.0,
    categoryId: 'premium_frappe',
  ),
  Product(
    id: 'pf_cookies_cream',
    name: 'Cookies & Cream Premium',
    basePrice: 65.0,
    categoryId: 'premium_frappe',
  ),
...
List<ModifierGroup> getModifierGroupsForProduct(Product product) {
  ...
  if (product.categoryId == 'milk_tea' ||
      product.categoryId == 'cheesecake' ||
      product.categoryId.startsWith('fruit_tea')) {
    sizeOptions.add(
      ModifierOption(
        id: 'sz_liter',
        groupId: 'size',
